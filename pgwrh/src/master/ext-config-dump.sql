...
SELECT pg_catalog.pg_extension_config_dump('credential_generation', '');
SELECT pg_catalog.pg_extension_config_dump('source_credential', '');
SELECT pg_catalog.pg_extension_config_dump('target_credential_verifier', '');
