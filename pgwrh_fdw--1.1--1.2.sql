/* contrib/pgwrh_fdw/pgwrh_fdw--1.1--1.2.sql */

-- complain if script is sourced in psql, rather than via ALTER EXTENSION
\echo Use "ALTER EXTENSION pgwrh_fdw UPDATE TO '1.2'" to load this file. \quit

/* First we have to remove it from the extension */
ALTER EXTENSION pgwrh_fdw DROP FUNCTION pgwrh_fdw_get_connections ();

/* Then we can drop it */
DROP FUNCTION pgwrh_fdw_get_connections ();
